...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  await user.save({ validateBeforeSave: false }); // we need to save the document, because in the middleware function, we modified the resetToken field, before it was empty.
