...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoibmhpbmNkZyIsImEiOiJjazBubjM0aHkwMW90M2NteDNsYzk1MDNwIn0.Be1JHEwcs-xzBA6GWMBEpg";
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            if (res.data.status === "success") location.reload(true); // Reload the server not the web page(cache)
...
var stripe = Stripe("pk_test_BZWhSYysbx7bJFJF7vV7mSiW00Pvv5faW4");
